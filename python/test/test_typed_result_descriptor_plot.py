...
class TestTypedResultDescriptorPlot(unittest.TestCase):
    """TypedResultDescriptorPlot unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TypedResultDescriptorPlot:
        """Test TypedResultDescriptorPlot
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TypedResultDescriptorPlot`
        """
        model = TypedResultDescriptorPlot()
        if include_optional:
            return TypedResultDescriptorPlot(
    ...
    def testTypedResultDescriptorPlot(self):
        """Test TypedResultDescriptorPlot"""
