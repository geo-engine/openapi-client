...
class GfbioAbcdDataProviderDefinition(BaseModel):
    """
    ...
    __properties = ["cacheTtl", "dbConfig", "description", "name", "priority"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GfbioAbcdDataProviderDefinition:
        """Create an instance of GfbioAbcdDataProviderDefinition from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GfbioAbcdDataProviderDefinition:
        """Create an instance of GfbioAbcdDataProviderDefinition from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GfbioAbcdDataProviderDefinition.parse_obj(obj)

        _obj = GfbioAbcdDataProviderDefinition.parse_obj({
