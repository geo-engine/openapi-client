 ...
 */
export function instanceOfColorizerLinearGradient(value) {
...
export function ColorizerLinearGradientFromJSON(json) {
    return ColorizerLinearGradientFromJSONTyped(json, false);
}
export function ColorizerLinearGradientFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function ColorizerLinearGradientToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
