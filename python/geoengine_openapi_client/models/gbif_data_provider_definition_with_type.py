...
class GbifDataProviderDefinitionWithType(BaseModel):
    """
    GbifDataProviderDefinitionWithType
    """
    ...
    __properties = ["autocompleteTimeout", "cacheTtl", "columns", "dbConfig", "description", "name", "priority", "type"]

    @validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('GbifDataProviderDefinition'):
            raise ValueError("must be one of enum values ('GbifDataProviderDefinition')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GbifDataProviderDefinitionWithType:
        """Create an instance of GbifDataProviderDefinitionWithType from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GbifDataProviderDefinitionWithType:
        """Create an instance of GbifDataProviderDefinitionWithType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GbifDataProviderDefinitionWithType.parse_obj(obj)

        _obj = GbifDataProviderDefinitionWithType.parse_obj({
