...
class TestTypedResultDescriptorRaster(unittest.TestCase):
    """TypedResultDescriptorRaster unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TypedResultDescriptorRaster:
        """Test TypedResultDescriptorRaster
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TypedResultDescriptorRaster`
        """
        model = TypedResultDescriptorRaster()
        if include_optional:
            return TypedResultDescriptorRaster(
                bands = [
    ...
    def testTypedResultDescriptorRaster(self):
        """Test TypedResultDescriptorRaster"""
