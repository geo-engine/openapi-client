...
class TestMetaDataDefinitionOgrMetaData(unittest.TestCase):
    """MetaDataDefinitionOgrMetaData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetaDataDefinitionOgrMetaData:
        """Test MetaDataDefinitionOgrMetaData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetaDataDefinitionOgrMetaData`
        """
        model = MetaDataDefinitionOgrMetaData()
        if include_optional:
            return MetaDataDefinitionOgrMetaData(
    ...
    def testMetaDataDefinitionOgrMetaData(self):
        """Test MetaDataDefinitionOgrMetaData"""
