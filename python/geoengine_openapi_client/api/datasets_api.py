...
from geoengine_openapi_client.models.delete_dataset_tiles import DeleteDatasetTiles
...
class DatasetsApi:
    ...
    @validate_call
    def delete_dataset_tiles_handler(
        self,
        dataset: Annotated[StrictStr, Field(description="Dataset Name")],
        delete_dataset_tiles: DeleteDatasetTiles,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param dataset: Dataset Name (required)
        :type dataset: str
        :param delete_dataset_tiles: (required)
        :type delete_dataset_tiles: DeleteDatasetTiles
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._delete_dataset_tiles_handler_serialize(
            dataset=dataset,
            delete_dataset_tiles=delete_dataset_tiles,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def delete_dataset_tiles_handler_with_http_info(
        self,
        dataset: Annotated[StrictStr, Field(description="Dataset Name")],
        delete_dataset_tiles: DeleteDatasetTiles,
        _request_timeout: Union[
    ...
    @validate_call
    def delete_dataset_tiles_handler_without_preload_content(
        self,
        dataset: Annotated[StrictStr, Field(description="Dataset Name")],
        delete_dataset_tiles: DeleteDatasetTiles,
        _request_timeout: Union[
    ...
    def _delete_dataset_tiles_handler_serialize(
        self,
        dataset,
        ...
        # process the form parameters
        # process the body parameter
        if delete_dataset_tiles is not None:
            _body_params = delete_dataset_tiles
