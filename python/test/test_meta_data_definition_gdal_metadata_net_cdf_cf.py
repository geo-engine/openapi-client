...
class TestMetaDataDefinitionGdalMetadataNetCdfCf(unittest.TestCase):
    """MetaDataDefinitionGdalMetadataNetCdfCf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetaDataDefinitionGdalMetadataNetCdfCf:
        """Test MetaDataDefinitionGdalMetadataNetCdfCf
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetaDataDefinitionGdalMetadataNetCdfCf`
        """
        model = MetaDataDefinitionGdalMetadataNetCdfCf()
        if include_optional:
            return MetaDataDefinitionGdalMetadataNetCdfCf(
                band_offset = 0,
                cache_ttl = 0,
                end = 56,
    ...
    def testMetaDataDefinitionGdalMetadataNetCdfCf(self):
        """Test MetaDataDefinitionGdalMetadataNetCdfCf"""
