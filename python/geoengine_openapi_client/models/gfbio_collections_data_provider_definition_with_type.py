...
class GfbioCollectionsDataProviderDefinitionWithType(BaseModel):
    """
    GfbioCollectionsDataProviderDefinitionWithType
    """
    ...
    __properties = ["abcdDbConfig", "cacheTtl", "collectionApiAuthToken", "collectionApiUrl", "description", "name", "pangaeaUrl", "priority", "type"]

    @validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('GfbioCollectionsDataProviderDefinition'):
            raise ValueError("must be one of enum values ('GfbioCollectionsDataProviderDefinition')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GfbioCollectionsDataProviderDefinitionWithType:
        """Create an instance of GfbioCollectionsDataProviderDefinitionWithType from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GfbioCollectionsDataProviderDefinitionWithType:
        """Create an instance of GfbioCollectionsDataProviderDefinitionWithType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GfbioCollectionsDataProviderDefinitionWithType.parse_obj(obj)

        _obj = GfbioCollectionsDataProviderDefinitionWithType.parse_obj({
