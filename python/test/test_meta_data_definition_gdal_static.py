...
class TestMetaDataDefinitionGdalStatic(unittest.TestCase):
    """MetaDataDefinitionGdalStatic unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetaDataDefinitionGdalStatic:
        """Test MetaDataDefinitionGdalStatic
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetaDataDefinitionGdalStatic`
        """
        model = MetaDataDefinitionGdalStatic()
        if include_optional:
            return MetaDataDefinitionGdalStatic(
                cache_ttl = 0,
    ...
    def testMetaDataDefinitionGdalStatic(self):
        """Test MetaDataDefinitionGdalStatic"""
