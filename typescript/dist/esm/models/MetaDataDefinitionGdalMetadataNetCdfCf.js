 ...
 */
export function instanceOfMetaDataDefinitionGdalMetadataNetCdfCf(value) {
...
export function MetaDataDefinitionGdalMetadataNetCdfCfFromJSON(json) {
    return MetaDataDefinitionGdalMetadataNetCdfCfFromJSONTyped(json, false);
}
export function MetaDataDefinitionGdalMetadataNetCdfCfFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function MetaDataDefinitionGdalMetadataNetCdfCfToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
