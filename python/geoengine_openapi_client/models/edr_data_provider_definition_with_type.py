...
class EdrDataProviderDefinitionWithType(BaseModel):
    """
    EdrDataProviderDefinitionWithType
    """
    ...
    __properties = ["baseUrl", "cacheTtl", "description", "discreteVrs", "id", "name", "priority", "provenance", "type", "vectorSpec"]

    @validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('EdrDataProviderDefinition'):
            raise ValueError("must be one of enum values ('EdrDataProviderDefinition')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EdrDataProviderDefinitionWithType:
        """Create an instance of EdrDataProviderDefinitionWithType from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EdrDataProviderDefinitionWithType:
        """Create an instance of EdrDataProviderDefinitionWithType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EdrDataProviderDefinitionWithType.parse_obj(obj)

        _obj = EdrDataProviderDefinitionWithType.parse_obj({
