...
class TestMetaDataDefinitionGdalMetaDataList(unittest.TestCase):
    """MetaDataDefinitionGdalMetaDataList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetaDataDefinitionGdalMetaDataList:
        """Test MetaDataDefinitionGdalMetaDataList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetaDataDefinitionGdalMetaDataList`
        """
        model = MetaDataDefinitionGdalMetaDataList()
        if include_optional:
            return MetaDataDefinitionGdalMetaDataList(
                params = [
    ...
    def testMetaDataDefinitionGdalMetaDataList(self):
        """Test MetaDataDefinitionGdalMetaDataList"""
