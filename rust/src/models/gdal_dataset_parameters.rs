...
pub struct GdalDatasetParameters {
    ...
    pub geo_transform: Box<models::GdalDatasetGeoTransform>,
    #[serde(rename = "height")]
    pub height: i32,
...
impl GdalDatasetParameters {
    ...
    pub fn new(file_not_found_handling: models::FileNotFoundHandling, file_path: String, geo_transform: models::GdalDatasetGeoTransform, height: i32, rasterband_channel: i32, width: i32) -> GdalDatasetParameters {
