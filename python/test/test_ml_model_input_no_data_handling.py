...
class TestMlModelInputNoDataHandling(unittest.TestCase):
    """MlModelInputNoDataHandling unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MlModelInputNoDataHandling:
        """Test MlModelInputNoDataHandling
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MlModelInputNoDataHandling`
        """
    ...
    def testMlModelInputNoDataHandling(self):
        """Test MlModelInputNoDataHandling"""
