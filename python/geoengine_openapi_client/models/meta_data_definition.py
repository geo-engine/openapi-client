...
from geoengine_openapi_client.models.static_meta_data import StaticMetaData
from pydantic import StrictStr, Field
from typing import Union, List, Set, Optional, Dict
from typing_extensions import Literal, Self

METADATADEFINITION_ONE_OF_SCHEMAS = ["GdalMetaDataList", "GdalMetaDataRegular", "GdalMetaDataStatic", "GdalMetadataNetCdfCf", "StaticMetaData"]

class MetaDataDefinition(BaseModel):
    """
    MetaDataDefinition
    """
    # data type: StaticMetaData
    oneof_schema_1_validator: Optional[StaticMetaData] = None
    # data type: StaticMetaData
    oneof_schema_2_validator: Optional[StaticMetaData] = None
    ...
    actual_instance: Optional[Union[GdalMetaDataList, GdalMetaDataRegular, GdalMetaDataStatic, GdalMetadataNetCdfCf, StaticMetaData]] = None
    one_of_schemas: Set[str] = { "GdalMetaDataList", "GdalMetaDataRegular", "GdalMetaDataStatic", "GdalMetadataNetCdfCf", "StaticMetaData" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        error_messages = []
        match = 0
        # validate data type: StaticMetaData
        if not isinstance(v, StaticMetaData):
            error_messages.append(f"Error! Input type `{type(v)}` is not `StaticMetaData`")
        else:
            match += 1
        # validate data type: StaticMetaData
        if not isinstance(v, StaticMetaData):
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in MetaDataDefinition with oneOf schemas: GdalMetaDataList, GdalMetaDataRegular, GdalMetaDataStatic, GdalMetadataNetCdfCf, StaticMetaData. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in MetaDataDefinition with oneOf schemas: GdalMetaDataList, GdalMetaDataRegular, GdalMetaDataStatic, GdalMetadataNetCdfCf, StaticMetaData. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # check if data type is `StaticMetaData`
        if _data_type == "MockMetaData":
            instance.actual_instance = StaticMetaData.from_json(json_str)
            return instance
        ...
        # check if data type is `StaticMetaData`
        if _data_type == "StaticMetaData":
            instance.actual_instance = StaticMetaData.from_json(json_str)
            return instance

        # deserialize data into StaticMetaData
        try:
            instance.actual_instance = StaticMetaData.from_json(json_str)
            match += 1
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into MetaDataDefinition with oneOf schemas: GdalMetaDataList, GdalMetaDataRegular, GdalMetaDataStatic, GdalMetadataNetCdfCf, StaticMetaData. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into MetaDataDefinition with oneOf schemas: GdalMetaDataList, GdalMetaDataRegular, GdalMetaDataStatic, GdalMetadataNetCdfCf, StaticMetaData. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], GdalMetaDataList, GdalMetaDataRegular, GdalMetaDataStatic, GdalMetadataNetCdfCf, StaticMetaData]]:
