...
class Provenances(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["provenances"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "provenances": [Provenance.from_dict(_item) for _item in obj["provenances"]] if obj.get("provenances") is not None else None
        })
        return _obj
