 ...
 */
export function instanceOfRasterColorizerMultiBand(value) {
    let isInstance = true;
...
export function RasterColorizerMultiBandFromJSON(json) {
    return RasterColorizerMultiBandFromJSONTyped(json, false);
}
export function RasterColorizerMultiBandFromJSONTyped(json, ignoreDiscriminator) {
...
export function RasterColorizerMultiBandToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
