...
class MockPointSourceParameters(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MockPointSourceParameters from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MockPointSourceParameters from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "points": [Coordinate2D.from_dict(_item) for _item in obj["points"]] if obj.get("points") is not None else None,
            "spatialBounds": SpatialBoundsDerive.from_dict(obj["spatialBounds"]) if obj.get("spatialBounds") is not None else None
        })
        return _obj
