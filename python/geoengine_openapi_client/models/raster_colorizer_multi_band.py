...
class RasterColorizerMultiBand(BaseModel):
    """
    ...
    __properties = ["blueBand", "blueMax", "blueMin", "blueScale", "greenBand", "greenMax", "greenMin", "greenScale", "redBand", "redMax", "redMin", "redScale", "type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RasterColorizerMultiBand:
        """Create an instance of RasterColorizerMultiBand from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RasterColorizerMultiBand:
        """Create an instance of RasterColorizerMultiBand from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RasterColorizerMultiBand.parse_obj(obj)

        _obj = RasterColorizerMultiBand.parse_obj({
