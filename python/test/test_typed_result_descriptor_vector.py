...
class TestTypedResultDescriptorVector(unittest.TestCase):
    """TypedResultDescriptorVector unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TypedResultDescriptorVector:
        """Test TypedResultDescriptorVector
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TypedResultDescriptorVector`
        """
        model = TypedResultDescriptorVector()
        if include_optional:
            return TypedResultDescriptorVector(
    ...
    def testTypedResultDescriptorVector(self):
        """Test TypedResultDescriptorVector"""
