...
class TestUpdateDatasetTile(unittest.TestCase):
    """UpdateDatasetTile unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateDatasetTile:
        """Test UpdateDatasetTile
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateDatasetTile`
        """
        model = UpdateDatasetTile()
        if include_optional:
            return UpdateDatasetTile(
                band = 0,
    ...
    def testUpdateDatasetTile(self):
        """Test UpdateDatasetTile"""
