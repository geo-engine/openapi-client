...
class PermissionsApi:
    ...
    def add_permission_handler(
        ...
        _param = self._add_permission_handler_serialize(
    ...
    @validate_call
    def add_permission_handler_with_http_info(
        self,
        permission_request: PermissionRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def add_permission_handler_without_preload_content(
        self,
        permission_request: PermissionRequest,
        _request_timeout: Union[
            None,
    ...
    def _add_permission_handler_serialize(
        self,
        permission_request,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def get_resource_permissions_handler(
        self,
        ...
        _param = self._get_resource_permissions_handler_serialize(
    ...
    @validate_call
    def get_resource_permissions_handler_with_http_info(
        self,
        resource_type: Annotated[StrictStr, Field(description="Resource Type")],
        resource_id: Annotated[StrictStr, Field(description="Resource Id")],
        limit: Annotated[int, Field(strict=True, ge=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[PermissionListing]]:
        """Lists permission for a given resource.
    ...
    @validate_call
    def get_resource_permissions_handler_without_preload_content(
        self,
        resource_type: Annotated[StrictStr, Field(description="Resource Type")],
        resource_id: Annotated[StrictStr, Field(description="Resource Id")],
        limit: Annotated[int, Field(strict=True, ge=0)],
    ...
    def _get_resource_permissions_handler_serialize(
        self,
        resource_type,
        resource_id,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/permissions/resources/{resource_type}/{resource_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def remove_permission_handler(
        ...
        _param = self._remove_permission_handler_serialize(
            permission_request=permission_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def remove_permission_handler_with_http_info(
        self,
        permission_request: PermissionRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def remove_permission_handler_without_preload_content(
        self,
        permission_request: PermissionRequest,
        _request_timeout: Union[
            None,
    ...
    def _remove_permission_handler_serialize(
        self,
        permission_request,
        _request_auth,
        _content_type,
