...
class TestMultiLineString1(unittest.TestCase):
    """MultiLineString1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MultiLineString1:
        """Test MultiLineString1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MultiLineString1`
        """
        model = MultiLineString1()
        if include_optional:
