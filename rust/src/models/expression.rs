...
impl Expression {
    ...
    pub fn new(params: models::ExpressionParameters, sources: models::SingleRasterSource, r#type: Type) -> Expression {
        Expression {
            params,
            sources,
            r#type,
