...
import { StacBandFromJSON, StacBandToJSON, } from './StacBand';
import { StacQueryBufferFromJSON, StacQueryBufferToJSON, } from './StacQueryBuffer';
import { StacZoneFromJSON, StacZoneToJSON, } from './StacZone';
/**
 * @export
 */
...
export function SentinelS2L2ACogsProviderDefinitionFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'apiUrl': json['apiUrl'],
        'bands': (json['bands'].map(StacBandFromJSON)),
        ...
        'type': json['type'],
        'zones': (json['zones'].map(StacZoneFromJSON)),
    };
}
...
export function SentinelS2L2ACogsProviderDefinitionToJSONTyped(value, ignoreDiscriminator = false) {
    ...
    return {
        'apiUrl': value['apiUrl'],
        'bands': (value['bands'].map(StacBandToJSON)),
        ...
        'type': value['type'],
        'zones': (value['zones'].map(StacZoneToJSON)),
    };
}
