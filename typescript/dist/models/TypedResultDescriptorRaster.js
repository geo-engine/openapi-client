...
exports.TypedResultDescriptorRasterToJSON = exports.TypedResultDescriptorRasterFromJSONTyped = exports.TypedResultDescriptorRasterFromJSON = exports.instanceOfTypedResultDescriptorRaster = exports.TypedResultDescriptorRasterTypeEnum = void 0;
 ...
 * @export
 */
exports.TypedResultDescriptorRasterTypeEnum = {
    Raster: 'raster'
};
/**
 * Check if a given object implements the TypedResultDescriptorRaster interface.
 */
function instanceOfTypedResultDescriptorRaster(value) {
    if (!('bands' in value))
        return false;
...
exports.instanceOfTypedResultDescriptorRaster = instanceOfTypedResultDescriptorRaster;
function TypedResultDescriptorRasterFromJSON(json) {
    return TypedResultDescriptorRasterFromJSONTyped(json, false);
}
exports.TypedResultDescriptorRasterFromJSON = TypedResultDescriptorRasterFromJSON;
function TypedResultDescriptorRasterFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
exports.TypedResultDescriptorRasterFromJSONTyped = TypedResultDescriptorRasterFromJSONTyped;
function TypedResultDescriptorRasterToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
...
exports.TypedResultDescriptorRasterToJSON = TypedResultDescriptorRasterToJSON;
