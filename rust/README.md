# Rust API client for geoengine-openapi-client
...
Put the package under your project folder in a directory named `geoengine-openapi-client` and add the following to `Cargo.toml` under `[dependencies]`:

```
geoengine-openapi-client = { path = "./geoengine-openapi-client" }
```
...
## Documentation For Models
 ...
 - [ColumnNamesOneOf](docs/ColumnNamesOneOf.md)
 - [ColumnNamesOneOf1](docs/ColumnNamesOneOf1.md)
 - [ColumnNamesOneOf2](docs/ColumnNamesOneOf2.md)
 ...
 - [SpatialBoundsDeriveOneOf](docs/SpatialBoundsDeriveOneOf.md)
 - [SpatialBoundsDeriveOneOf1](docs/SpatialBoundsDeriveOneOf1.md)
 - [SpatialBoundsDeriveOneOf2](docs/SpatialBoundsDeriveOneOf2.md)
